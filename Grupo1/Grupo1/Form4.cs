...
namespace Grupo1.Properties
{
    public partial class Form4 : Form
    {
        ...
        String query = "SELECT `nombre`, `tipo`, `detalle`, `precio`,`img` FROM `indumentaria` WHERE 1";
        ...
        {
            query = "SELECT `nombre`, `tipo`, `detalle`, `precio`,`img` FROM `indumentaria` WHERE `tipo` = \"gorra\";";
            ...
            {
                query = "SELECT `nombre`, `tipo`, `detalle`, `precio`,`img` FROM `indumentaria` WHERE `categoria_id` = \"3\";";
            }
            if (radPiluso.Checked == true)
            {
                query = "SELECT `nombre`, `tipo`, `detalle`, `precio`,`img` FROM `indumentaria` WHERE `categoria_id` = \"1\";";
            }
            if (radPlanas.Checked == true)
            {
                query = "SELECT `nombre`, `tipo`, `detalle`, `precio`,`img` FROM `indumentaria` WHERE `categoria_id` = \"2\";";
            }
        ...
        {
            query = "SELECT `nombre`, `tipo`, `detalle`, `precio`,`img` FROM `indumentaria` WHERE `tipo` = \"zapatilla\";";
            ...
            {
                query = "SELECT `nombre`, `tipo`, `detalle`, `precio`,`img` FROM `indumentaria` WHERE `genero_id` = \"1\";";
            }
            if (radMujer.Checked == true)
            {
                query = "SELECT `nombre`, `tipo`, `detalle`, `precio`,`img` FROM `indumentaria` WHERE `genero_id` = \"2\";";
            }
            if (radMinimal.Checked == true)
            {
                query = "SELECT `nombre`, `tipo`, `detalle`, `precio`,`img` FROM `indumentaria` WHERE `categoria_id` = \"6\";";
            }
            if (radRunning.Checked == true)
            {
                query = "SELECT `nombre`, `tipo`, `detalle`, `precio`,`img` FROM `indumentaria` WHERE `categoria_id` = \"5\";";
            }
            if (radTenis.Checked == true)
            {
                query = "SELECT `nombre`, `tipo`, `detalle`, `precio`,`img`  FROM `indumentaria` WHERE `categoria_id` = \"4\";";
            }
        ...
        private void dgIndumentaria_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
