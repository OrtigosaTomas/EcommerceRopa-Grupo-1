        ...
        public bool crearZapatilla(Zapatilla zap)
        {
                ...
                try
                {
                    ...
                    using (MySqlConnection myCon = new MySqlConnection(cadenaConexion))
                    {
                        ...
                        using (MySqlCommand cmd = new MySqlCommand("INSERT INTO indumentaria (id, nombre, tipo, detalle, precio, genero_id, categoria_id, talle, stock,img) VALUES (@id, @nombre, @tipo, @detalle, @precio, @genero, @categoria, @talle, @stock,@img)", myCon))
                        {
                        ...
                        cmd.Parameters.AddWithValue("@talle", zap.Talle);
                        cmd.Parameters.AddWithValue("@stock", zap.Stock);
                        cmd.Parameters.AddWithValue("@img", zap.Img);
