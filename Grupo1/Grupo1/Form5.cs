    ...
    public partial class Form5 : Form
    {
        ...
        private void boton_crear_Click_1(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (txt_nombre1.Text.TrimStart() == string.Empty && txt_detalle1.Text.TrimStart() == string.Empty && txt_precio1.Text.TrimStart() == string.Empty && txt_stockid1.Text.TrimStart() == string.Empty)
                { 
                    MessageBox.Show("Debe ingresar el dato solicitado");
                
                }else if (IsNumeric(txt_stockid1.Text.Trim()) && IsNumeric(txt_precio1.Text.TrimStart() ))
                {
